                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">${student.payment.total_fee}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Amount Paid:</span>
                      <span className="font-medium text-emerald-600">${student.payment.amount_paid}</span>
                    </div>
                    <div className="flex justify-between border-t pt-2 mt-2">
                      <span className="font-medium">Balance Due:</span>
                      <span className="font-bold text-rose-600">${student.payment.balance_amount}</span>
                    </div>
                  </div>
